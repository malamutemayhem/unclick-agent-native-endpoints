...
<body>
  ...
  <p class="meta" style="margin-top:2rem;">Generated by UXPass deterministic runner. Queued critics are reserved for the LLM hat panel and Playwright capture chunks.</p>
</body>
</html>`;
}
