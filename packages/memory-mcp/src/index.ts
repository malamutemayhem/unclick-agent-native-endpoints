...
server.tool(
  "add_fact",
  "Add a new extracted fact to memory. Facts are atomic, searchable pieces of knowledge. Examples: 'Team prefers Tailwind over CSS modules', 'The Supabase project ref is xmooqsylqlknuksiddca'.",
  {
