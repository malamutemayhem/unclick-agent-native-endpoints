...
export const PINBALLWAKE_JOB_RUNNERS: PinballWakeJobRunner[] = [
  {
    id: "master-codex-desktop",
    emoji: "🧠",
    name: "Master Codex",
    kind: "codex-desktop",
    host: "Lenovo Codex desktop",
    readiness: "builder_ready",
    capabilities: ["implementation", "qc_review", "merge_proof", "status_relay"],
  ...
  {
    id: "xpass-product-context",
    emoji: "🧪",
    name: "XPass Assistant",
    kind: "chat-only",
  ...
  },
  {
    ...
    nextProbe: "Run a zero-risk repo-access probe: read Fishbowl, branch, tiny docs/test chip, PR.",
  },
  {
    id: "courier-relay",
    emoji: "📣",
