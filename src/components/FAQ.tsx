    ...
    items: [
      {
        ...
        a: "UnClick currently offers 69 tools across categories including web, productivity, data, communication, news, music, events, and more. New tools are added regularly.",
      },
      {
