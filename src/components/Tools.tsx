...
import {
  ...
  KeyRound, TrendingUp,
  Flag, Trophy, Crown, Ticket, Newspaper, Film,
  Terminal, Mic, Music, Disc3, Mic2, ListMusic, Radio,
  MapPin, BarChart2, Bitcoin, ArrowLeftRight,
  CloudLightning, Rocket, Map, Thermometer,
  HelpCircle, Building2, Train, Tv, Star,
} from "lucide-react";
...
const tools: Tool[] = [
  ...
  {
    name: "OpenF1",
    description: "Live and historical Formula 1 data via the free OpenF1 API. Fetch session results, driver standings, lap times, pit stop data, car telemetry, team radio, and weather conditions for any race weekend. Zero authentication required. Built for agents building F1 dashboards, race analysis tools, and motorsport recap pipelines.",
    endpoint: "openf1",
    category: "Data",
    Icon: Flag,
    capabilities: [
      "Get sessions, drivers, and position history for any race weekend",
      "Lap times, sector splits, and pit stop data per driver",
      "Car telemetry: speed, throttle, brake, DRS, and gear per data point",
      "Team radio messages and weather data for any session",
    ],
    examplePrompt: "Ask your AI to fetch the lap times and pit stop data from the last F1 race",
  },
  {
    name: "FPL",
    description: "Official Fantasy Premier League data with no API key required. Access player stats, fixture difficulty ratings, live gameweek scores, league standings, and manager team selections. Everything the FPL app shows you, available to your AI agent. Built for agents automating transfer decisions, scouting differentials, and tracking mini-league standings.",
    endpoint: "fpl",
    category: "Data",
    Icon: Trophy,
    capabilities: [
      "Full player database with price, form, points, and ownership percentage",
      "Live gameweek scores and fixture lists with difficulty ratings",
      "League standings with full pagination for classic and head-to-head leagues",
      "Manager team picks and chip usage history for any gameweek",
    ],
    examplePrompt: "Ask your AI to find the top scoring midfielders under 7.0m in FPL this season",
  },
  {
    name: "Chess.com",
    description: "Chess.com player profiles, ratings, and game history via the free public API. Get player stats by game type, retrieve monthly game archives, fetch leaderboards, and pull random puzzles. No authentication needed. Built for agents building chess coaching tools, player comparison dashboards, and puzzle training pipelines.",
    endpoint: "chessdotcom",
    category: "Data",
    Icon: Crown,
    capabilities: [
      "Player profiles with ratings for bullet, blitz, rapid, and daily chess",
      "Monthly game archives with full PGN data",
      "Global leaderboards by game type and time control",
      "Random daily puzzles for training and coaching workflows",
    ],
    examplePrompt: "Ask your AI to compare two Chess.com players by their bullet and blitz ratings",
  },
  {
    name: "Lichess",
    description: "Open-source chess platform data via the free Lichess API. Fetch player profiles, rating history, recent games, daily puzzles, top player leaderboards, and tournament details. Completely free with no key required. Built for agents building chess analytics, puzzle trainers, and tournament tracking tools.",
    endpoint: "lichess",
    category: "Data",
    Icon: Crown,
    capabilities: [
      "Player profiles with performance ratings for all Lichess variants",
      "Recent game history with full PGN and analysis links",
      "Daily puzzle with solution and themes",
      "Top player leaderboards and tournament details",
    ],
    examplePrompt: "Ask your AI to fetch the daily Lichess puzzle and explain the winning line",
  },
  {
    name: "Ticketmaster",
    description: "Event discovery and venue data from the Ticketmaster Discovery API. Search live events by keyword, city, country, and date range; get venue details; and find attractions and performers by classification. Returns ticket availability, pricing tiers, and direct booking links. Built for agents building event discovery, local guide, and entertainment recommendation features.",
    endpoint: "ticketmaster",
    category: "Data",
    Icon: Ticket,
    capabilities: [
      "Search events by keyword, city, country, and date range",
      "Venue details including capacity, location, and accessible facilities",
      "Attraction and performer search by classification (music, sports, arts)",
      "Ticket availability indicators and direct purchase links",
    ],
    examplePrompt: "Ask your AI to find upcoming concerts near Melbourne in the next 30 days",
  },
  {
    name: "SeatGeek",
    description: "Event ticketing and venue data from SeatGeek. Search events, performers, and venues with location filtering. Get real-time ticket listings, price ranges, deal scores, and seating charts. Built for agents comparing ticket prices, building local event guides, and alerting users to newly available seats for sold-out shows.",
    endpoint: "seatgeek",
    category: "Data",
    Icon: Ticket,
    capabilities: [
      "Search events by keyword, location, type, and date range",
      "Performer profiles with popularity scores and upcoming events",
      "Venue details with seating chart links and location data",
      "Ticket listings with price ranges, deal scores, and buy links",
    ],
    examplePrompt: "Ask your AI to search SeatGeek for NBA games happening this week and compare ticket prices",
  },
  // ── News & Media ───────────────────────────────────────────────────────────
  {
    name: "The Guardian",
    description: "Search and retrieve articles from The Guardian's full content archive via the official API. Filter by section, date range, and tags. Retrieve full article body text, images, and metadata. Free API key available. Built for agents building news digests, content research tools, and media monitoring pipelines.",
    endpoint: "guardian",
    category: "Data",
    Icon: Newspaper,
    capabilities: [
      "Search articles across all Guardian sections with keyword and date filters",
      "Retrieve full article body text, byline, and publication date",
      "Browse available sections, tags, and editions",
      "Sort by relevance, newest, or oldest with pagination support",
    ],
    examplePrompt: "Ask your AI to search The Guardian for articles about climate policy from the last 7 days",
  },
  {
    name: "NewsAPI",
    description: "Aggregate breaking news and headlines from 80,000+ sources worldwide via NewsAPI. Search by keyword, domain, language, and date range. Fetch top headlines by country or category. Requires an API key. Built for agents building news briefings, topic monitoring systems, and content curation pipelines.",
    endpoint: "newsapi",
    category: "Data",
    Icon: Newspaper,
    capabilities: [
      "Top headlines by country, category, or news source",
      "Full-text article search with date range, language, and domain filters",
      "80,000+ sources covering global, regional, and niche publications",
      "Sort by relevance, popularity, or publish date",
    ],
    examplePrompt: "Ask your AI to fetch the top 10 technology headlines from the last 24 hours",
  },
  {
    name: "TMDB",
    description: "The Movie Database (TMDB) movie and TV metadata. Search titles, get cast and crew, fetch trending content, find what's now playing in theaters, and browse upcoming releases. Free API key required. Built for agents building recommendation engines, watchlist tools, and entertainment content pipelines.",
    endpoint: "tmdb",
    category: "Media",
    Icon: Film,
    capabilities: [
      "Search movies and TV shows with year and language filters",
      "Detailed movie and TV info including cast, crew, genres, and ratings",
      "Trending movies and TV by day or week",
      "Now playing in theaters, upcoming releases, and popular TV shows",
    ],
    examplePrompt: "Ask your AI to find trending movies this week and summarize the top 5 with cast details",
  },
  {
    name: "OMDB",
    description: "Open Movie Database (OMDB) metadata for movies and TV shows. Search by title, look up by IMDb ID, and retrieve ratings from IMDb, Rotten Tomatoes, and Metacritic in one call. Requires a free API key. Built for agents building review aggregators, content recommendation tools, and trivia applications.",
    endpoint: "omdb",
    category: "Media",
    Icon: Film,
    capabilities: [
      "Search movies and TV by title with optional year filter",
      "Look up specific titles by IMDb ID for exact matches",
      "Aggregated ratings from IMDb, Rotten Tomatoes, and Metacritic",
      "Full metadata: director, cast, genre, runtime, plot, and awards",
    ],
    examplePrompt: "Ask your AI to look up a movie by IMDb ID and return its Rotten Tomatoes score",
  },
  {
    name: "HackerNews",
    description: "Hacker News stories, items, and user profiles from the official Firebase API. Fetch top, new, best, Ask HN, and Show HN stories in real time. Retrieve any item or user profile by ID. Completely free with no authentication required. Built for agents building tech news digests, community pulse trackers, and link aggregators.",
    endpoint: "hackernews",
    category: "Data",
    Icon: Terminal,
    capabilities: [
      "Top, new, best, Ask HN, and Show HN story feeds in real time",
      "Full item details: title, URL, score, comment count, and author",
      "User profiles with karma, creation date, and submission history",
      "No API key or authentication required",
    ],
    examplePrompt: "Ask your AI to fetch the top 10 Hacker News stories right now and summarize them",
  },
  {
    name: "Podcast Index",
    description: "Search and browse 4 million+ podcasts and episodes via the Podcast Index API. Find podcasts by keyword, browse episodes by feed, search within episode transcripts, and discover trending shows. Requires a free API key. Built for agents building podcast discovery tools, episode search engines, and audio content pipelines.",
    endpoint: "podcastindex",
    category: "Media",
    Icon: Mic,
    capabilities: [
      "Search 4 million+ podcasts by keyword with category and language filters",
      "Episode listings by feed with full metadata and audio URLs",
      "Trending podcasts by language and category",
      "Recent episodes across all indexed feeds",
    ],
    examplePrompt: "Ask your AI to find the top trending technology podcasts and list their latest episodes",
  },
  // ── Music ──────────────────────────────────────────────────────────────────
  {
    name: "Last.fm",
    description: "Artist info, top tracks, similar artists, and global charts from Last.fm. Look up scrobble counts, biography text, album details, and find similar artists for recommendations. Requires a free API key. Built for agents building music recommendation systems, artist discovery tools, and listening history pipelines.",
    endpoint: "lastfm",
    category: "Media",
    Icon: Music,
    capabilities: [
      "Artist info: biography, listener count, playcount, and tags",
      "Top tracks and albums per artist with play counts",
      "Similar artist discovery for recommendation workflows",
      "Global top artists and top tracks charts",
    ],
    examplePrompt: "Ask your AI to find 5 artists similar to a given artist using Last.fm data",
  },
  {
    name: "Discogs",
    description: "Search and retrieve music release, artist, and label data from the Discogs database. Find releases by format, genre, year, and label. Get marketplace statistics including lowest, median, and highest sale prices. Requires a Discogs API token. Built for agents building vinyl catalogues, music price trackers, and collection management tools.",
    endpoint: "discogs",
    category: "Media",
    Icon: Disc3,
    capabilities: [
      "Search releases with artist, genre, year, format, and label filters",
      "Detailed release info: tracklist, formats, labels, and identifiers",
      "Artist and label profiles with discography links",
      "Marketplace price statistics: lowest, median, and highest sale prices",
    ],
    examplePrompt: "Ask your AI to search Discogs for first-press vinyl releases of a specific album and check market prices",
  },
  {
    name: "MusicBrainz",
    description: "Open music encyclopedia with detailed metadata on artists, releases, and recordings. Search by name and retrieve MBIDs, aliases, release groups, and recording details. Completely free with no API key required. Built for agents building music databases, tag enrichment tools, and catalog normalization pipelines.",
    endpoint: "musicbrainz",
    category: "Media",
    Icon: Database,
    capabilities: [
      "Search artists, releases, and recordings by name",
      "MusicBrainz IDs (MBIDs) for canonical cross-referencing",
      "Artist aliases, genres, release groups, and area information",
      "No API key required, fully open database",
    ],
    examplePrompt: "Ask your AI to look up an artist on MusicBrainz and retrieve their official release list",
  },
  {
    name: "Genius",
    description: "Song and artist data from Genius including full song metadata, annotations, and artist profiles. Search songs by title, look up artist catalogues, and retrieve song details with album and producer credits. Requires a Genius API key. Built for agents building lyrics reference tools, music trivia apps, and artist research workflows.",
    endpoint: "genius",
    category: "Media",
    Icon: Mic2,
    capabilities: [
      "Search songs by title and return metadata with annotation counts",
      "Song details: album, release date, producer credits, and featured artists",
      "Artist profiles with biography and song catalogues",
      "Sort artist songs by popularity, title, or release date",
    ],
    examplePrompt: "Ask your AI to search Genius for a song and return its album, producer, and featured artist credits",
  },
  {
    name: "Bandsintown",
    description: "Concert and tour data from Bandsintown. Get artist profiles, upcoming and past events, and recommended artists for a location. Retrieve event details including venue, date, ticket links, and lineup. Requires an app_id. Built for agents building concert discovery tools, tour tracking pipelines, and local music event guides.",
    endpoint: "bandsintown",
    category: "Media",
    Icon: CalendarDays,
    capabilities: [
      "Artist profiles with upcoming and past event counts",
      "Upcoming events with venue, date, lineup, and ticket links",
      "Filter events by date range",
      "Recommended artists based on location and genre",
    ],
    examplePrompt: "Ask your AI to find upcoming concerts for a specific artist and return the dates and venues",
  },
  {
    name: "Setlist.fm",
    description: "Concert setlist history from Setlist.fm. Search artists, retrieve setlists by artist MusicBrainz ID, search setlists by city or venue, and look up specific setlists by ID. Requires a free API key. Built for agents building concert recap tools, song frequency trackers, and tour history archives.",
    endpoint: "setlistfm",
    category: "Media",
    Icon: ListMusic,
    capabilities: [
      "Artist search with MusicBrainz ID lookup",
      "Full setlist history for any artist with song order and encore flags",
      "Search setlists by city, venue, year, or tour name",
      "Individual setlist details with venue coordinates and supporting acts",
    ],
    examplePrompt: "Ask your AI to retrieve the last 5 setlists for an artist and identify the most played songs",
  },
  {
    name: "Radio Browser",
    description: "Search and discover 50,000+ internet radio stations from the Community Radio Browser. Filter by country, language, genre tag, and codec. Get top clicked and top voted stations. No authentication required. Built for agents building radio discovery tools, music streaming directories, and audio background content pipelines.",
    endpoint: "radiobrowser",
    category: "Media",
    Icon: Radio,
    capabilities: [
      "Search stations by name, country, language, and genre tag",
      "Top clicked and top voted stations globally",
      "Browse stations by country with listener counts",
      "Station metadata: stream URL, codec, bitrate, and homepage",
    ],
    examplePrompt: "Ask your AI to find the top 10 jazz radio stations and return their stream URLs",
  },
  // ── Events & Places ────────────────────────────────────────────────────────
  {
    name: "Eventbrite",
    description: "Event discovery and management via the Eventbrite API. Search public events by location, category, and date range. Retrieve event details, venue info, and attendee lists. Create new events programmatically. Requires an Eventbrite API key. Built for agents managing event logistics, building local event guides, and automating registration workflows.",
    endpoint: "eventbrite",
    category: "Data",
    Icon: Ticket,
    capabilities: [
      "Search events by location, category, date range, and keyword",
      "Full event details: description, schedule, capacity, and ticket tiers",
      "Venue details including address and coordinates",
      "Create new events with title, description, schedule, and organizer",
    ],
    examplePrompt: "Ask your AI to find free tech meetups in Sydney this month on Eventbrite",
  },
  {
    name: "Foursquare",
    description: "Place search and discovery via the Foursquare Places API. Search venues by query and location, retrieve place details, photos, and user tips. Autocomplete place names for search interfaces. Requires a Foursquare API key. Built for agents building local discovery features, venue research tools, and location-aware recommendation engines.",
    endpoint: "foursquare",
    category: "Data",
    Icon: MapPin,
    capabilities: [
      "Search places by query, location, and category filters",
      "Place details: address, hours, rating, and contact info",
      "Photos and user tips for any venue",
      "Autocomplete for building search-as-you-type place interfaces",
    ],
    examplePrompt: "Ask your AI to find the top-rated coffee shops within 500m of a given address",
  },
  // ── Finance & Crypto ───────────────────────────────────────────────────────
  {
    name: "Alpha Vantage",
    description: "Stock market, forex, and cryptocurrency data from Alpha Vantage. Get real-time and historical OHLCV data, search for ticker symbols, and retrieve intraday bar data at custom intervals. Free API key required with higher tiers available. Built for agents building trading dashboards, financial research tools, and portfolio tracking pipelines.",
    endpoint: "alphavantage",
    category: "Data",
    Icon: BarChart2,
    capabilities: [
      "Real-time stock quotes with price, volume, and change percentage",
      "Daily and intraday OHLCV bars at 1, 5, 15, 30, or 60-minute intervals",
      "Forex exchange rates between any two currencies",
      "Cryptocurrency daily data in any target market currency",
    ],
    examplePrompt: "Ask your AI to fetch the last 30 days of daily OHLCV data for a stock and calculate its average volume",
  },
  {
    name: "CoinGecko",
    description: "Cryptocurrency market data from CoinGecko's free public API. Get live prices for multiple coins, detailed coin info with market cap and 24h volume, trending coins, and historical price data. No API key required for basic use. Built for agents building crypto dashboards, price alert systems, and DeFi research pipelines.",
    endpoint: "coingecko",
    category: "Data",
    Icon: Coins,
    capabilities: [
      "Live prices for multiple coins in any fiat or crypto currency",
      "Detailed coin data: market cap, volume, ATH, supply, and description",
      "Trending coins and top coins by market cap with pagination",
      "Historical price on any specific date",
    ],
    examplePrompt: "Ask your AI to get the current prices of Bitcoin, Ethereum, and Solana in AUD",
  },
  {
    name: "CoinMarketCap",
    description: "Professional cryptocurrency market data from CoinMarketCap. Get latest listings with full market data, quotes for specific coins, trending assets, and global market metrics. Requires a CoinMarketCap API key. Built for agents building institutional-grade crypto dashboards, market summary tools, and automated reporting pipelines.",
    endpoint: "coinmarketcap",
    category: "Data",
    Icon: TrendingUp,
    capabilities: [
      "Latest crypto listings ranked by market cap with full market data",
      "Quotes for specific coins by symbol or ID",
      "Trending cryptocurrencies by page views and trading volume",
      "Global market metrics: total market cap, BTC dominance, and 24h volume",
    ],
    examplePrompt: "Ask your AI to fetch the top 20 cryptocurrencies by market cap and calculate the total market value",
  },
  {
    name: "Open Exchange Rates",
    description: "Live and historical currency exchange rates from Open Exchange Rates. Get rates for all currencies relative to a base, convert specific amounts, retrieve historical rates for any past date, and list all supported currency names. Free plan available. Built for agents handling multi-currency pricing, financial reporting, and invoice generation.",
    endpoint: "openexchangerates",
    category: "Data",
    Icon: ArrowLeftRight,
    capabilities: [
      "Latest rates for 170+ currencies relative to any base currency",
      "Historical rates for any date back to 1999",
      "Direct amount conversion between any two currencies",
      "Full list of supported currency names and codes",
    ],
    examplePrompt: "Ask your AI to convert 1,000 AUD to USD, EUR, and GBP using today's live rates",
  },
  {
    name: "Wise",
    description: "International money transfer data and quotes from Wise (formerly TransferWise). Get live exchange rates, create transfer quotes with exact conversion amounts and fees, and retrieve account balances for connected profiles. Requires a Wise API key. Built for agents automating international payroll, FX cost comparisons, and cross-border payment workflows.",
    endpoint: "wise",
    category: "Commerce",
    Icon: ArrowLeftRight,
    capabilities: [
      "Live exchange rates between any two currencies with optional amount conversion",
      "Transfer quotes showing exact converted amount, fees, and delivery estimate",
      "Connected profile and account balance retrieval",
      "Support for personal and business Wise accounts",
    ],
    examplePrompt: "Ask your AI to get a Wise quote for sending 5,000 USD to a GBP account and show the fee",
  },
  {
    name: "Tomorrow.io",
    description: "Weather intelligence from Tomorrow.io with real-time conditions, hourly and daily forecasts, and historical weather data. Supports location by address, coordinates, or city name. Requires a Tomorrow.io API key. Built for agents building weather-aware logistics systems, agricultural planning tools, and dynamic content that responds to local conditions.",
    endpoint: "tomorrowio",
    category: "Data",
    Icon: CloudLightning,
    capabilities: [
      "Real-time weather: temperature, humidity, wind, UV index, and visibility",
      "Hourly and daily forecasts with precipitation probability and snowfall",
      "Historical weather data for any past time range",
      "Location input as address string, city name, or lat/lon coordinates",
    ],
    examplePrompt: "Ask your AI to get a 7-day weather forecast for a city and flag any days with rain above 50%",
  },
  // ── Science & Data ─────────────────────────────────────────────────────────
  {
    name: "NASA",
    description: "NASA open data: Astronomy Picture of the Day, Near-Earth asteroid tracking, Mars rover photos, Earth satellite imagery, and EPIC daily Earth images. Uses a free DEMO_KEY or your own key for higher rate limits. Built for agents building space education tools, asteroid alert systems, and science content pipelines.",
    endpoint: "nasa",
    category: "Data",
    Icon: Rocket,
    capabilities: [
      "Astronomy Picture of the Day (APOD) with explanation and image URL",
      "Near-Earth asteroid feed for any date range with hazard flags",
      "Mars rover photos from Curiosity, Opportunity, and Perseverance",
      "Earth satellite imagery and daily EPIC full-disc Earth photos",
    ],
    examplePrompt: "Ask your AI to fetch today's NASA Astronomy Picture of the Day and summarize its description",
  },
  {
    name: "REST Countries",
    description: "Comprehensive country data for all 250 countries and territories. Get names, codes, capitals, regions, currencies, languages, flags, population, and timezone data. Free with no API key required. Built for agents building address forms, geographic filters, localization tools, and international data enrichment workflows.",
    endpoint: "restcountries",
    category: "Data",
    Icon: Map,
    capabilities: [
      "All 250 countries with flag, capital, region, and population data",
      "Look up countries by name, ISO code, region, currency, or language",
      "Currency and language metadata per country",
      "Fully open, no API key or rate limiting",
    ],
    examplePrompt: "Ask your AI to list all countries in Southeast Asia with their official currencies",
  },
  {
    name: "IP-API",
    description: "Fast IP geolocation for any IPv4 or IPv6 address. Returns country, region, city, latitude, longitude, timezone, ISP, and organization. Batch look up to 100 IPs in one request. Completely free for non-commercial use, no key needed. Built for agents performing geo-based personalization, fraud detection, and network intelligence workflows.",
    endpoint: "ipapi",
    category: "Network",
    Icon: Network,
    capabilities: [
      "Geolocation for any IPv4 or IPv6: country, city, region, and coordinates",
      "ISP, organization, and AS number for network intelligence",
      "Batch lookup up to 100 IPs in a single call",
      "No API key required for non-commercial use",
    ],
    examplePrompt: "Ask your AI to look up the country and ISP for a list of IP addresses from server logs",
  },
  {
    name: "Open-Meteo",
    description: "Free weather forecasts and current conditions from Open-Meteo without any API key. Get current weather, multi-day forecasts, and 48-hour hourly data for any city or coordinates. Built on high-resolution European weather models. Built for agents that need weather data in any workflow without managing API keys or rate limits.",
    endpoint: "openmeteo",
    category: "Data",
    Icon: Thermometer,
    capabilities: [
      "Current weather: temperature, wind, humidity, and weather condition code",
      "Multi-day daily forecast with high/low, precipitation, and sunrise/sunset",
      "48-hour hourly forecast with temperature and precipitation",
      "Accepts city name or lat/lon coordinates, no API key needed",
    ],
    examplePrompt: "Ask your AI to get the current weather and 5-day forecast for any city without an API key",
  },
  {
    name: "Open Library",
    description: "Book metadata, author profiles, and trending titles from the Open Library (Internet Archive). Search books by title, author, or ISBN. Retrieve full work details, edition information, and author bibliographies. Completely free, no key required. Built for agents building reading lists, book recommendation tools, and library catalog integrations.",
    endpoint: "openlibrary",
    category: "Data",
    Icon: BookOpen,
    capabilities: [
      "Search books by title, author, subject, or ISBN",
      "Work and edition details: publisher, pages, languages, and covers",
      "Author profiles with biography and full bibliography",
      "Trending books updated daily",
    ],
    examplePrompt: "Ask your AI to search Open Library for books by a specific author and return their most recent publications",
  },
  // ── Fun & Zero-Config ──────────────────────────────────────────────────────
  {
    name: "Trivia",
    description: "Random trivia questions from the Open Trivia Database. Choose difficulty, category, and question type (multiple choice or true/false). Fetch available categories and request up to 50 questions per call. Completely free, no API key needed. Built for agents building quiz games, pub trivia tools, and educational flashcard applications.",
    endpoint: "trivia",
    category: "Utility",
    Icon: HelpCircle,
    capabilities: [
      "50,000+ questions across 24 categories and 3 difficulty levels",
      "Multiple choice and true/false question types",
      "Shuffle answer options automatically to prevent order bias",
      "No API key required, fully open database",
    ],
    examplePrompt: "Ask your AI to generate 10 hard science trivia questions for a quiz night",
  },
  {
    name: "Numbers API",
    description: "Interesting facts about numbers from the Numbers API. Get trivia, math, date, and year facts for any specific number or a random one. Completely free with no authentication required. Built for agents adding numeric context to data, building educational content, and creating engaging number-based trivia.",
    endpoint: "numbers",
    category: "Utility",
    Icon: Hash,
    capabilities: [
      "Trivia facts: surprising and interesting properties of any number",
      "Math facts: notable mathematical properties and theorems",
      "Date facts: historical events that happened on a given day of the year",
      "Year facts: notable events from any year in history",
    ],
    examplePrompt: "Ask your AI to fetch an interesting trivia fact about the number 42",
  },
  // ── AU Tools ───────────────────────────────────────────────────────────────
  {
    name: "ABN Lookup",
    description: "Look up Australian businesses by ABN or search by name via the free Australian Business Register API. Returns business name, ABN, entity type, GST registration status, and address. No key required for basic lookup. Built for agents verifying Australian supplier or contractor details, onboarding workflows, and invoice validation pipelines.",
    endpoint: "abn",
    category: "Data",
    Icon: Building2,
    capabilities: [
      "Look up any business by its 11-digit Australian Business Number",
      "Search businesses by name with optional postcode filter",
      "Entity type, GST registration status, and business address",
      "No API key required for standard lookups",
    ],
    examplePrompt: "Ask your AI to look up an ABN and confirm the business name and GST status",
  },
  {
    name: "PTV",
    description: "Real-time Public Transport Victoria (Melbourne) data via the official PTV API. Search stops and routes, get live departures, check service disruptions, and retrieve stops along any route. Requires a PTV developer ID and API key. Built for agents building Melbourne transit tools, commute planners, and real-time journey assistants.",
    endpoint: "ptv",
    category: "Data",
    Icon: Train,
    capabilities: [
      "Search stops, routes, and stations by name or route type",
      "Live departure times for any stop with optional route filter",
      "Current and scheduled service disruptions by route type",
      "All stops on any route in sequence",
    ],
    examplePrompt: "Ask your AI to get the next 5 train departures from Flinders Street Station",
  },
  // ── Other ──────────────────────────────────────────────────────────────────
  {
    name: "Twitch",
    description: "Live stream and gaming data from the Twitch API. Search streams and games, get live viewer counts, retrieve channel info, fetch clips, and view upcoming broadcast schedules. Requires a Twitch Client ID and OAuth token. Built for agents building gaming dashboards, streamer discovery tools, and esports monitoring pipelines.",
    endpoint: "twitch",
    category: "Social",
    Icon: Tv,
    capabilities: [
      "Search live streams by game or keyword with viewer count sorting",
      "Top games currently being streamed on Twitch",
      "Channel info, recent clips, and upcoming broadcast schedules",
      "Live stream status for any channel with real-time viewer count",
    ],
    examplePrompt: "Ask your AI to find the top 10 live Twitch streams for a specific game right now",
  },
  {
    name: "Yelp",
    description: "Business search, reviews, and local events from the Yelp Fusion API. Search businesses by location, category, price range, and radius. Retrieve reviews, ratings, photos, and hours. Search local events by date and category. Requires a Yelp API key. Built for agents building local guide tools, restaurant recommenders, and experience discovery features.",
    endpoint: "yelp",
    category: "Commerce",
    Icon: Star,
    capabilities: [
      "Business search by location, category, price tier, and radius",
      "Business details: rating, review count, hours, photos, and contact info",
      "Customer reviews with star rating and text excerpts",
      "Local event search by location, date, and category",
    ],
    examplePrompt: "Ask your AI to find the top 5 Italian restaurants near a given address with their Yelp ratings",
  },
];
